...
| 400
| Bad Request
| <<CurationErrorResponse,CurationErrorResponse>>
...
array[<<EntityTypeDescriptor,EntityTypeDescriptor>>]
...
| 200
| Successful Response
| List[<<EntityTypeDescriptor,EntityTypeDescriptor>>]
...
| X
| 
| <<CurationErrorCode,CurationErrorCode>>
| 
