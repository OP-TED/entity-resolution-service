...
This project is indexed by GitNexus as **entity-resolution-service** (2516 symbols, 4750 relationships, 67 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
