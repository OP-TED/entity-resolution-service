...
This project is indexed by GitNexus as **entity-resolution-service** (3692 symbols, 8686 relationships, 117 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
