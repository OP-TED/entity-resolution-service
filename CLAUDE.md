...
This project is indexed by GitNexus as **entity-resolution-service** (3689 symbols, 8676 relationships, 116 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
