...
This project is indexed by GitNexus as **entity-resolution-service** (3512 symbols, 7829 relationships, 113 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
