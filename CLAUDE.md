...
This project is indexed by GitNexus as **entity-resolution-service** (4069 symbols, 9790 relationships, 148 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
