...
This project is indexed by GitNexus as **entity-resolution-service** (4037 symbols, 9708 relationships, 148 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
