...
This project is indexed by GitNexus as **entity-resolution-service** (3529 symbols, 7889 relationships, 113 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
