...
This project is indexed by GitNexus as **entity-resolution-service** (3671 symbols, 8462 relationships, 115 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
