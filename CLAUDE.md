...
This project is indexed by GitNexus as **entity-resolution-service** (4032 symbols, 9745 relationships, 156 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
